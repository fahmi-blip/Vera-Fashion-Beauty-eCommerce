  ...
  return (
    <div className="space-y-12" id="customer-editorial-view">
      ...
      <div className="text-center max-w-xl mx-auto space-y-3">
        ...
        <p className="text-stone-500 text-xs tracking-wide leading-relaxed font-sans font-light">
          Dapatkan panduan perawatan kulit berbasis riset ilmiah serta rahasia padu padan lemari pakaian kapsul (*capsule wardrobe*) berkelanjutan yang dikurasi khusus untuk gaya hidup elit Anda.
        </p>
      </div>
        ...
        {articles.map((article) => (
          ...
          >
            <div className="space-y-4">
              ...
              <div className="w-full h-32 bg-stone-50 border border-stone-100 flex items-center justify-center text-stone-300 font-mono text-[8px] uppercase tracking-widest rounded-none">
                <Sparkles className="w-3.5 h-3.5 mr-1.5" /> {article.image}
              </div>
